...
Elm['Styles']['General'] = Elm['Styles']['General'] || {};
if (typeof _meilab$elm_wexin_crypto$Styles_General$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Styles_General$main(Elm['Styles']['General'], 'Styles.General', undefined);
}
