			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('主密钥'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('服务名(例如：taotao)'),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('密码长度'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
Elm['Password']['Views'] = Elm['Password']['Views'] || {};
if (typeof _meilab$elm_wexin_crypto$Password_Views$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Password_Views$main(Elm['Password']['Views'], 'Password.Views', undefined);
}
