...
Elm['Password']['Models'] = Elm['Password']['Models'] || {};
if (typeof _meilab$elm_wexin_crypto$Password_Models$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Password_Models$main(Elm['Password']['Models'], 'Password.Models', undefined);
}
