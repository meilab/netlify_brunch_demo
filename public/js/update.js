...
Elm['Password']['Update'] = Elm['Password']['Update'] || {};
if (typeof _meilab$elm_wexin_crypto$Password_Update$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Password_Update$main(Elm['Password']['Update'], 'Password.Update', undefined);
}
