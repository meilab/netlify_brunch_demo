...
var Elm = {};
Elm['ContentUtils'] = Elm['ContentUtils'] || {};
if (typeof _meilab$elm_wexin_crypto$ContentUtils$main !== 'undefined') {
    _meilab$elm_wexin_crypto$ContentUtils$main(Elm['ContentUtils'], 'ContentUtils', undefined);
}
