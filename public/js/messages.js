...
Elm['Password']['Messages'] = Elm['Password']['Messages'] || {};
if (typeof _meilab$elm_wexin_crypto$Password_Messages$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Password_Messages$main(Elm['Password']['Messages'], 'Password.Messages', undefined);
}
