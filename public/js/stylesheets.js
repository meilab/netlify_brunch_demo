...
var _meilab$elm_wexin_crypto$Styles_Colors$drawer = A4(_rtfeldman$elm_css$Css$rgba, 30, 30, 29, 0.95);
var _meilab$elm_wexin_crypto$Styles_Colors$fire = _rtfeldman$elm_css$Css$hex('#e73536');
var _meilab$elm_wexin_crypto$Styles_Colors$ember = A4(_rtfeldman$elm_css$Css$rgba, 164, 0, 48, 0.5);
var _meilab$elm_wexin_crypto$Styles_Colors$bloodOrange = _rtfeldman$elm_css$Css$hex('#fb5f26');
var _meilab$elm_wexin_crypto$Styles_Colors$coal = _rtfeldman$elm_css$Css$hex('#2d2d2d');
var _meilab$elm_wexin_crypto$Styles_Colors$charcoal = _rtfeldman$elm_css$Css$hex('#595959');
var _meilab$elm_wexin_crypto$Styles_Colors$panther = _rtfeldman$elm_css$Css$hex('#161616');
var _meilab$elm_wexin_crypto$Styles_Colors$windowTint = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.4);
var _meilab$elm_wexin_crypto$Styles_Colors$cloud = A4(_rtfeldman$elm_css$Css$rgba, 200, 200, 200, 0.35);
var _meilab$elm_wexin_crypto$Styles_Colors$frost = _rtfeldman$elm_css$Css$hex('#D8D8D8');
var _meilab$elm_wexin_crypto$Styles_Colors$ricePaper = A4(_rtfeldman$elm_css$Css$rgba, 255, 255, 255, 0.75);
var _meilab$elm_wexin_crypto$Styles_Colors$transparent = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0);
var _meilab$elm_wexin_crypto$Styles_Colors$error = A4(_rtfeldman$elm_css$Css$rgba, 200, 0, 0, 0.8);
var _meilab$elm_wexin_crypto$Styles_Colors$steel = _rtfeldman$elm_css$Css$hex('#CCCCCC');
var _meilab$elm_wexin_crypto$Styles_Colors$facebook = _rtfeldman$elm_css$Css$hex('#3b5998');
var _meilab$elm_wexin_crypto$Styles_Colors$clear = A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0);
var _meilab$elm_wexin_crypto$Styles_Colors$ribbonBackground = _rtfeldman$elm_css$Css$hex('#1F0808');
var _meilab$elm_wexin_crypto$Styles_Colors$contentBordercolor = _rtfeldman$elm_css$Css$hex('#e4dad1');
var _meilab$elm_wexin_crypto$Styles_Colors$bordercolor = _rtfeldman$elm_css$Css$hex('#564944');
var _meilab$elm_wexin_crypto$Styles_Colors$background = _rtfeldman$elm_css$Css_Colors$white;
...
var _meilab$elm_wexin_crypto$Styles_SharedVariables$contentBorder = A3(
	_rtfeldman$elm_css$Css$border3,
	_rtfeldman$elm_css$Css$px(1),
	_rtfeldman$elm_css$Css$solid,
	_rtfeldman$elm_css$Css$hex('#e4dad1'));
var _meilab$elm_wexin_crypto$Styles_SharedVariables$buttonRadius = _rtfeldman$elm_css$Css$px(4);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$searchBarHeight = _rtfeldman$elm_css$Css$px(30);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$horizontalLineHeight = _rtfeldman$elm_css$Css$px(1);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$smallMargin = _rtfeldman$elm_css$Css$px(5);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$doubleBaseMargin = _rtfeldman$elm_css$Css$px(20);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$sectionMargin = _rtfeldman$elm_css$Css$px(25);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$baseMargin = _rtfeldman$elm_css$Css$px(10);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$marginVertical = _rtfeldman$elm_css$Css$px(10);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$marginHorizontal = _rtfeldman$elm_css$Css$px(10);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$menuMarginLeft = _rtfeldman$elm_css$Css$px(-150);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$menuHeadingWidth = _rtfeldman$elm_css$Css$px(40);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$toggleMenuLeftCollapsed = _rtfeldman$elm_css$Css$px(20);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$toggleMenuLeft = _rtfeldman$elm_css$Css$px(150 + 20);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$menuWidth = _rtfeldman$elm_css$Css$px(150);
var _meilab$elm_wexin_crypto$Styles_SharedVariables$navBarHeight = _rtfeldman$elm_css$Css$px(64);

var _meilab$elm_wexin_crypto$Styles_General$css = function (_p0) {
	return _rtfeldman$elm_css$Css$stylesheet(
		A2(_rtfeldman$elm_css$Css_Namespace$namespace, _meilab$elm_wexin_crypto$Styles_SharedStyles$meilabNamespace.name, _p0));
}(
	{
		ctor: '::',
							...
							_1: {
								...
								_1: {
									...
									_0: _rtfeldman$elm_css$Css$backgroundColor(
										_rtfeldman$elm_css$Css$hex('#fbf7ed')),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$color(
											_rtfeldman$elm_css$Css$hex('#434343')),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css_Elements$nav(
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										_meilab$elm_wexin_crypto$Styles_SharedStyles$Container,
										{
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$displayFlex,
											_1: {
									...
									_1: {
										...
										_0: A2(
											_rtfeldman$elm_css$Css$class,
											_meilab$elm_wexin_crypto$Styles_SharedStyles$HeaderNavWrapper,
											{
												ctor: '::',
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$Layout),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$IntroLayout),
														_1: {ctor: '[]'}
													}
												},
												{
											...
											_1: {
												...
												_0: A2(
													_rtfeldman$elm_css$Css$class,
													_meilab$elm_wexin_crypto$Styles_SharedStyles$Layout,
													{
														ctor: '::',
														_0: _rtfeldman$elm_css$Css$marginTop(_meilab$elm_wexin_crypto$Styles_SharedVariables$navBarHeight),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														_rtfeldman$elm_css$Css$class,
														_meilab$elm_wexin_crypto$Styles_SharedStyles$ContentContainer,
														{
															ctor: '::',
													...
													_1: {
														...
														_0: A2(
															_rtfeldman$elm_css$Css$class,
															_meilab$elm_wexin_crypto$Styles_SharedStyles$MarkdownWrapper,
															{
																ctor: '::',
																_0: _rtfeldman$elm_css$Css$displayFlex,
																_1: {
														...
														_1: {
															...
															_0: A2(
																_rtfeldman$elm_css$Css$class,
																_meilab$elm_wexin_crypto$Styles_SharedStyles$MarkdownContent,
																{
																	ctor: '::',
																	_0: _rtfeldman$elm_css$Css$width(
															...
															_1: {
																...
																_0: A2(
																	_rtfeldman$elm_css$Css$class,
																	_meilab$elm_wexin_crypto$Styles_SharedStyles$NavigationContentContainer,
																	{
																		ctor: '::',
																		_0: _rtfeldman$elm_css$Css$width(
																			_rtfeldman$elm_css$Css$vw(90)),
																		_1: {
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$minHeight(
																				A3(
																					_rtfeldman$elm_css$Css$calc,
																					_rtfeldman$elm_css$Css$vh(90),
																					_rtfeldman$elm_css$Css$minus,
																					_meilab$elm_wexin_crypto$Styles_SharedVariables$navBarHeight)),
																			_1: {
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$displayFlex,
																				_1: {
																...
																_1: {
																	...
																	_0: A2(
																		_rtfeldman$elm_css$Css$class,
																		_meilab$elm_wexin_crypto$Styles_SharedStyles$NavigationMenuContainer,
																		{
																			ctor: '::',
																			_0: _rtfeldman$elm_css$Css$width(
																				_rtfeldman$elm_css$Css$pct(100)),
																	...
																	_1: {
																		...
																		_0: A2(
																			_rtfeldman$elm_css$Css$class,
																			_meilab$elm_wexin_crypto$Styles_SharedStyles$GeneratorContainer,
																			{
																				ctor: '::',
																				_0: _rtfeldman$elm_css$Css$width(
																					_rtfeldman$elm_css$Css$pct(100)),
																		...
																		_1: {
																			...
																			_0: A2(
																				...
																				{
																					ctor: '::',
																					_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$MetaContainer),
																					_1: {
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$ServiceItemMetaContainer),
																						_1: {ctor: '[]'}
																					}
																				},
																				{
																								...
																								_1: {
																									...
																									_1: {
																										...
																										_0: A3(
																											...
																											_rtfeldman$elm_css$Css$px(1),
																											_rtfeldman$elm_css$Css$solid,
																											_meilab$elm_wexin_crypto$Styles_Colors$contentBordercolor),
																										_1: {ctor: '[]'}
																									}
																								}
																							}
																			...
																			_1: {
																				...
																				_0: A2(
																					_rtfeldman$elm_css$Css$class,
																					_meilab$elm_wexin_crypto$Styles_SharedStyles$ServiceItemMetaContainer,
																					{
																						ctor: '::',
																						_0: _rtfeldman$elm_css$Css$height(
																				...
																				_1: {
																					...
																					_0: A2(
																						_rtfeldman$elm_css$Css$class,
																						_meilab$elm_wexin_crypto$Styles_SharedStyles$MetaItem,
																						{
																							ctor: '::',
																							_0: _rtfeldman$elm_css$Css$displayFlex,
																							_1: {
																					...
																					_1: {
																						...
																						_0: A2(
																							_rtfeldman$elm_css$Css$class,
																							_meilab$elm_wexin_crypto$Styles_SharedStyles$CursorPoint,
																							{
																								ctor: '::',
																						...
																						_1: {
																							...
																							_0: A2(
																								_rtfeldman$elm_css$Css$class,
																								_meilab$elm_wexin_crypto$Styles_SharedStyles$GeneratorFormContainer,
																								{
																									ctor: '::',
																									_0: _rtfeldman$elm_css$Css$width(
																										_rtfeldman$elm_css$Css$pct(90)),
																							...
																							_1: {
																								...
																								_0: A2(
																									_rtfeldman$elm_css$Css$class,
																									_meilab$elm_wexin_crypto$Styles_SharedStyles$GeneratorFormItem,
																									{
																										ctor: '::',
																										_0: _rtfeldman$elm_css$Css$displayFlex,
																										_1: {
																								...
																								_1: {
																									...
																									_0: A2(
																										_rtfeldman$elm_css$Css$class,
																										_meilab$elm_wexin_crypto$Styles_SharedStyles$CategorySelectorContainer,
																										{
																											ctor: '::',
																											_0: _rtfeldman$elm_css$Css$width(
																												_rtfeldman$elm_css$Css$pct(100)),
																									...
																									_1: {
																										...
																										_0: A2(
																											_rtfeldman$elm_css$Css$class,
																											_meilab$elm_wexin_crypto$Styles_SharedStyles$CategorySelector,
																											{ctor: '[]'}),
																										_1: {
																											ctor: '::',
																											_0: A2(
																												...
																												{
																													ctor: '::',
																													_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuContainer),
																													_1: {
																														ctor: '::',
																														_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuContainerVertical),
																														_1: {ctor: '[]'}
																													}
																												},
																												{
																											...
																											_1: {
																												...
																												_0: A2(
																													_rtfeldman$elm_css$Css$class,
																													_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuContainerVertical,
																													{
																														ctor: '::',
																														_0: _rtfeldman$elm_css$Css$flexDirection(_rtfeldman$elm_css$Css$column),
																														_1: {ctor: '[]'}
																												...
																												_1: {
																													...
																													_0: A2(
																														_rtfeldman$elm_css$Css$class,
																														_meilab$elm_wexin_crypto$Styles_SharedStyles$SideBarWrapper,
																														{
																															ctor: '::',
																															_0: A3(
																																...
																																_rtfeldman$elm_css$Css$int(0),
																																_meilab$elm_wexin_crypto$Styles_SharedVariables$menuWidth),
																															_1: {
																																ctor: '::',
																																_0: A2(
																																	_rtfeldman$elm_css$Css$withClass,
																																	_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuInActive,
																																	{
																																		ctor: '::',
																																		_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$none),
																																		_1: {ctor: '[]'}
																													...
																													_1: {
																														...
																														_0: A2(
																															_rtfeldman$elm_css$Css$class,
																															_meilab$elm_wexin_crypto$Styles_SharedStyles$SideBarMenu,
																															{
																																ctor: '::',
																																_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$fixed),
																																_1: {
																																	ctor: '::',
																																	_0: _rtfeldman$elm_css$Css$width(_meilab$elm_wexin_crypto$Styles_SharedVariables$menuWidth),
																																	_1: {
																																		ctor: '::',
																																		_0: _rtfeldman$elm_css$Css$height(
																																			_rtfeldman$elm_css$Css$vh(100)),
																																		_1: {
																																			...
																																			_1: {
																																				...
																																				_1: {
																																					...
																																					_1: {
																																						ctor: '::',
																																						_0: _rtfeldman$elm_css$Css$backgroundColor(_meilab$elm_wexin_crypto$Styles_Colors$ember),
																																						_1: {ctor: '[]'}
																																					}
																																				}
																																			}
																														...
																														_1: {
																															...
																															_0: A2(
																																...
																																{
																																	ctor: '::',
																																	_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$HeaderNavContainer),
																																	_1: {
																																		ctor: '::',
																																		_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$FooterNavContainer),
																																		_1: {ctor: '[]'}
																																	}
																																},
																																{
																															...
																															_1: {
																																...
																																_0: A2(
																																	_rtfeldman$elm_css$Css$class,
																																	_meilab$elm_wexin_crypto$Styles_SharedStyles$InfoPageHeaderNav,
																																	{
																																		ctor: '::',
																																		_0: _rtfeldman$elm_css$Css$descendants(
																																			{
																																...
																																_1: {
																																	...
																																	_0: A2(
																																		_rtfeldman$elm_css$Css$class,
																																		_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuItem,
																																		{
																																			ctor: '::',
																																												...
																																												_0: _rtfeldman$elm_css$Css$hover(
																																													{
																																														ctor: '::',
																																														_0: _rtfeldman$elm_css$Css$backgroundColor(
																																															_rtfeldman$elm_css$Css$hex('#8A7667')),
																																														_1: {ctor: '[]'}
																																													}),
																																												_1: {ctor: '[]'}
																																											}),
																																	...
																																	_1: {
																																		...
																																		_0: A2(
																																			_rtfeldman$elm_css$Css$class,
																																			_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuToggler,
																																			{
																																				ctor: '::',
																																				_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$fixed),
																																				_1: {
																																					...
																																					_1: {
																																						...
																																						_1: {
																																							ctor: '::',
																																							_0: _rtfeldman$elm_css$Css$left(_meilab$elm_wexin_crypto$Styles_SharedVariables$toggleMenuLeftCollapsed),
																																							_1: {
																																								ctor: '::',
																																								...
																																								_1: {
																																									...
																																									_0: A3(
																																										...
																																										_rtfeldman$elm_css$Css$px(1),
																																										_rtfeldman$elm_css$Css$solid,
																																										_rtfeldman$elm_css$Css_Colors$silver),
																																									_1: {
																																										ctor: '::',
																																										_0: _rtfeldman$elm_css$Css$descendants(
																																											{
																																										...
																																										_1: {
																																											...
																																											_0: A2(
																																												_rtfeldman$elm_css$Css$withClass,
																																												_meilab$elm_wexin_crypto$Styles_SharedStyles$MenuActive,
																																												{
																																													ctor: '::',
																																													_0: _rtfeldman$elm_css$Css$left(_meilab$elm_wexin_crypto$Styles_SharedVariables$toggleMenuLeft),
																																													_1: {ctor: '[]'}
																																												}),
																																											_1: {
																																												ctor: '::',
																																		...
																																		_1: {
																																			...
																																			_0: A2(
																																				_rtfeldman$elm_css$Css$class,
																																				_meilab$elm_wexin_crypto$Styles_SharedStyles$HeaderNav,
																																				{
																																					ctor: '::',
																																					_0: _rtfeldman$elm_css$Css$displayFlex,
																																					_1: {
																																											...
																																											_0: _rtfeldman$elm_css$Css_Elements$a(
																																												{
																																													...
																																													_1: {
																																														...
																																														_0: _rtfeldman$elm_css$Css$hover(
																																															{
																																																ctor: '::',
																																																_0: _rtfeldman$elm_css$Css$color(_rtfeldman$elm_css$Css_Colors$yellow),
																																																_1: {ctor: '[]'}
																																															}),
																																														_1: {
																																															ctor: '::',
																																															_0: _rtfeldman$elm_css$Css$active(
																																																{
																																																	ctor: '::',
																																																	_0: _rtfeldman$elm_css$Css$color(_rtfeldman$elm_css$Css_Colors$yellow),
																																																	_1: {ctor: '[]'}
																																			...
																																			_1: {
																																				...
																																				_0: A2(
																																					_rtfeldman$elm_css$Css$class,
																																					_meilab$elm_wexin_crypto$Styles_SharedStyles$SearchBar,
																																					{
																																						ctor: '::',
																																						_0: _rtfeldman$elm_css$Css$width(
																																							_rtfeldman$elm_css$Css$pct(90)),
																																							...
																																							_1: {
																																								...
																																								_1: {
																																									...
																																									_1: {
																																										...
																																										_1: {
																																											ctor: '::',
																																											_0: _meilab$elm_wexin_crypto$Styles_SharedVariables$contentBorder,
																																											_1: {
																																												ctor: '::',
																																												_0: _rtfeldman$elm_css$Css$backgroundColor(
																																													_rtfeldman$elm_css$Css$hex('#fbf7ed')),
																																				...
																																				_1: {
																																					...
																																					_0: A2(
																																						_rtfeldman$elm_css$Css$class,
																																						_meilab$elm_wexin_crypto$Styles_SharedStyles$SearchIcon,
																																						{
																																							ctor: '::',
																																							_0: A3(
																																								_rtfeldman$elm_css$Css$flex3,
																																					...
																																					_1: {
																																						...
																																						_0: A2(
																																							_rtfeldman$elm_css$Css$class,
																																							_meilab$elm_wexin_crypto$Styles_SharedStyles$SearchClear,
																																							{
																																								ctor: '::',
																																								_0: A3(
																																									_rtfeldman$elm_css$Css$flex3,
																																						...
																																						_1: {
																																							...
																																							_0: A2(
																																								_rtfeldman$elm_css$Css$class,
																																								_meilab$elm_wexin_crypto$Styles_SharedStyles$Searcher,
																																								{
																																									ctor: '::',
																																									_0: _rtfeldman$elm_css$Css$flex(
																																										_rtfeldman$elm_css$Css$int(1)),
																																							...
																																							_1: {
																																								...
																																								_0: A2(
																																									_rtfeldman$elm_css$Css$class,
																																									_meilab$elm_wexin_crypto$Styles_SharedStyles$IconImg,
																																									{
																																										ctor: '::',
																																										_0: _rtfeldman$elm_css$Css$width(
																																								...
																																								_1: {
																																									...
																																									_0: A2(
																																										_rtfeldman$elm_css$Css$class,
																																										_meilab$elm_wexin_crypto$Styles_SharedStyles$ServiceContainer,
																																										{
																																											ctor: '::',
																																											_0: _rtfeldman$elm_css$Css$displayFlex,
																																											_1: {
																																									...
																																									_1: {
																																										...
																																										_0: A2(
																																											_rtfeldman$elm_css$Css$class,
																																											_meilab$elm_wexin_crypto$Styles_SharedStyles$ServiceItem,
																																											{
																																												ctor: '::',
																																												_0: _rtfeldman$elm_css$Css$displayFlex,
																																												_1: {
																																																...
																																																_1: {
																																																	...
																																																	_1: {
																																																		...
																																																		_0: A5(
																																																			...
																																																			A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 3.0e-2)),
																																																		_1: {
																																																			ctor: '::',
																																																			_0: _rtfeldman$elm_css$Css$hover(
																																																				{
																																																					ctor: '::',
																																																					_0: _rtfeldman$elm_css$Css$backgroundColor(
																																																						_rtfeldman$elm_css$Css$hex('#f1ece1')),
																																																					_1: {
																																																						ctor: '::',
																																																						_0: A4(
																																										...
																																										_1: {
																																											...
																																											_0: A2(
																																												_rtfeldman$elm_css$Css$class,
																																												_meilab$elm_wexin_crypto$Styles_SharedStyles$ServiceDescription,
																																												{
																																													ctor: '::',
																																													_0: _rtfeldman$elm_css$Css$width(
																																														_rtfeldman$elm_css$Css$pct(100)),
																																											...
																																											_1: {
																																												...
																																												_0: A2(
																																													_rtfeldman$elm_css$Css$class,
																																													_meilab$elm_wexin_crypto$Styles_SharedStyles$ServiceCreatedTime,
																																													{
																																														ctor: '::',
																																														_0: A3(
																																															_rtfeldman$elm_css$Css$flex3,
																																												...
																																												_1: {
																																													...
																																													_0: A2(
																																														_rtfeldman$elm_css$Css$class,
																																														_meilab$elm_wexin_crypto$Styles_SharedStyles$FolderListWrapper,
																																														{
																																															ctor: '::',
																																															_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$fixed),
																																															_1: {
																																																ctor: '::',
																																																_0: _rtfeldman$elm_css$Css$top(_meilab$elm_wexin_crypto$Styles_SharedVariables$navBarHeight),
																																																_1: {
																																																	ctor: '::',
																																																	_0: _rtfeldman$elm_css$Css$width(
																																																		_rtfeldman$elm_css$Css$pct(100)),
																																																	_1: {
																																																		...
																																																		_1: {
																																																			...
																																																			_1: {
																																																				...
																																																				_0: A2(
																																																					_rtfeldman$elm_css$Css$withClass,
																																																					_meilab$elm_wexin_crypto$Styles_SharedStyles$FolderListInActive,
																																																					{
																																																						ctor: '::',
																																																						_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$none),
																																																						_1: {ctor: '[]'}
																																													...
																																													_1: {
																																														...
																																														_0: A2(
																																															_rtfeldman$elm_css$Css$class,
																																															_meilab$elm_wexin_crypto$Styles_SharedStyles$FolderTransferWrapper,
																																															{
																																																ctor: '::',
																																																_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$fixed),
																																																_1: {
																																																		...
																																																		_1: {
																																																			...
																																																			_1: {
																																																				...
																																																				_1: {
																																																					...
																																																					_0: A2(
																																																						_rtfeldman$elm_css$Css$withClass,
																																																						_meilab$elm_wexin_crypto$Styles_SharedStyles$FolderTransferInActive,
																																																						{
																																																							ctor: '::',
																																																							_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$none),
																																																							_1: {ctor: '[]'}
																																														...
																																														_1: {
																																															...
																																															_0: A2(
																																																_rtfeldman$elm_css$Css$class,
																																																_meilab$elm_wexin_crypto$Styles_SharedStyles$Disclaimer,
																																																{
																																																	ctor: '::',
																																																	_0: _rtfeldman$elm_css$Css$marginTop(
																																															...
																																															_1: {
																																																...
																																																_0: A2(
																																																	_rtfeldman$elm_css$Css$class,
																																																	_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownContainer,
																																																	{
																																																		ctor: '::',
																																																...
																																																_1: {
																																																	...
																																																	_0: A2(
																																																		...
																																																		{
																																																			ctor: '::',
																																																			_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownInput),
																																																			_1: {
																																																				ctor: '::',
																																																				_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownInputWithBorder),
																																																				_1: {ctor: '[]'}
																																																			}
																																																		},
																																																		{
																																																	...
																																																	_1: {
																																																		...
																																																		_0: A2(
																																																			_rtfeldman$elm_css$Css$class,
																																																			_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownInputWithBorder,
																																																			{
																																																				ctor: '::',
																																																				_0: A3(
																																																					_rtfeldman$elm_css$Css$border3,
																																																		...
																																																		_1: {
																																																			...
																																																			_0: A2(
																																																				_rtfeldman$elm_css$Css$class,
																																																				_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownDisabled,
																																																				{
																																																					ctor: '::',
																																																					_0: _rtfeldman$elm_css$Css$color(
																																																						A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.54)),
																																																					_1: {ctor: '[]'}
																																																				}),
																																																			_1: {
																																																				ctor: '::',
																																																				_0: A2(
																																																					_rtfeldman$elm_css$Css$class,
																																																					_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownText,
																																																					{
																																																						ctor: '::',
																																																				...
																																																				_1: {
																																																					...
																																																					_0: A2(
																																																						_rtfeldman$elm_css$Css$class,
																																																						_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownList,
																																																						{
																																																							ctor: '::',
																																																								...
																																																								_1: {
																																																									...
																																																									_1: {
																																																										...
																																																										_0: A4(
																																																											...
																																																											A4(_rtfeldman$elm_css$Css$rgba, 0, 0, 0, 0.24)),
																																																										_1: {
																																																											ctor: '::',
																																																											_0: A2(
																																																					...
																																																					_1: {
																																																						...
																																																						_0: A2(
																																																							_rtfeldman$elm_css$Css$class,
																																																							_meilab$elm_wexin_crypto$Styles_SharedStyles$DropdownListItem,
																																																							{
																																																								ctor: '::',
																																																								_0: _rtfeldman$elm_css$Css$displayFlex,
																																																								_1: {
																																																									...
																																																									_1: {
																																																										...
																																																										_1: {
																																																											...
																																																											_1: {
																																																												ctor: '::',
																																																												_0: _rtfeldman$elm_css$Css$color(
																																																													_rtfeldman$elm_css$Css$hex('#7a706b')),
																																																												_1: {
																																																													ctor: '::',
																																																													_0: A3(
																																																														_rtfeldman$elm_css$Css$borderBottom3,
																																																														_rtfeldman$elm_css$Css$px(1),
																																																														_rtfeldman$elm_css$Css$solid,
																																																														_rtfeldman$elm_css$Css$hex('#f2f2f1')),
																																																													_1: {
																																																														ctor: '::',
																																																														_0: _rtfeldman$elm_css$Css$cursor(_rtfeldman$elm_css$Css$pointer),
																																																														_1: {
																																																															...
																																																															_0: _rtfeldman$elm_css$Css$hover(
																																																																{
																																																																	ctor: '::',
																																																																	_0: _rtfeldman$elm_css$Css$backgroundColor(
																																																																		_rtfeldman$elm_css$Css$hex('#f5f2f1')),
																																																																	_1: {
																																																																		ctor: '::',
																																																																		_0: A4(
																																																																			_rtfeldman$elm_css$Css$boxShadow4,
																																																						...
																																																						_1: {
																																																							...
																																																							_0: A2(
																																																								_rtfeldman$elm_css$Css$class,
																																																								_meilab$elm_wexin_crypto$Styles_SharedStyles$Arrow,
																																																								{
																																																									ctor: '::',
																																																									_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
																																																									_1: {
																																																														...
																																																														_1: {
																																																															...
																																																															_1: {
																																																																...
																																																																_0: A3(
																																																																	...
																																																																	_rtfeldman$elm_css$Css$px(7),
																																																																	_rtfeldman$elm_css$Css$solid,
																																																																	_rtfeldman$elm_css$Css$hex('#e2dcd6')),
																																																																_1: {
																																																																	ctor: '::',
																																																																	_0: A3(
																																																							...
																																																							_1: {
																																																								...
																																																								_0: A2(
																																																									_rtfeldman$elm_css$Css$class,
																																																									_meilab$elm_wexin_crypto$Styles_SharedStyles$GroupButton,
																																																									{
																																																										ctor: '::',
																																																										_0: _rtfeldman$elm_css$Css$width(
																																																								...
																																																								_1: {
																																																									...
																																																									_0: A2(
																																																										_rtfeldman$elm_css$Css$class,
																																																										_meilab$elm_wexin_crypto$Styles_SharedStyles$GroupButtonDisabled,
																																																										{
																																																											ctor: '::',
																																																											_0: _rtfeldman$elm_css$Css$display(_rtfeldman$elm_css$Css$none),
																																																											_1: {ctor: '[]'}
																																																									...
																																																									_1: {
																																																										...
																																																										_0: A2(
																																																											_rtfeldman$elm_css$Css$class,
																																																											_meilab$elm_wexin_crypto$Styles_SharedStyles$Hero,
																																																											{
																																																												ctor: '::',
																																																												_0: _rtfeldman$elm_css$Css$color(_rtfeldman$elm_css$Css_Colors$white),
																																																												_1: {
																																																													...
																																																													_1: {
																																																														...
																																																														_1: {
																																																															...
																																																															_1: {
																																																																ctor: '::',
																																																																_0: _rtfeldman$elm_css$Css$backgroundAttachment(_rtfeldman$elm_css$Css$fixed),
																																																																_1: {
																																																																	ctor: '::',
																																																										...
																																																										_1: {
																																																											...
																																																											_0: A2(
																																																												_rtfeldman$elm_css$Css$class,
																																																												_meilab$elm_wexin_crypto$Styles_SharedStyles$Footer,
																																																												{
																																																													ctor: '::',
																																																													_0: _rtfeldman$elm_css$Css$backgroundColor(
																																																														_rtfeldman$elm_css$Css$hex('#fbf7ed')),
																																																											...
																																																											_1: {
																																																												...
																																																												_0: A2(
																																																													_rtfeldman$elm_css$Css$class,
																																																													_meilab$elm_wexin_crypto$Styles_SharedStyles$CopyRight,
																																																													{
																																																														ctor: '::',
																																																														_0: _rtfeldman$elm_css$Css$flex(
																																																															_rtfeldman$elm_css$Css$int(1)),
																																																												...
																																																												_1: {
																																																													...
																																																													_0: A2(
																																																														_rtfeldman$elm_css$Css$class,
																																																														_meilab$elm_wexin_crypto$Styles_SharedStyles$GithubIframe,
																																																														{
																																																															ctor: '::',
																																																															_0: _rtfeldman$elm_css$Css$border(_rtfeldman$elm_css$Css$zero),
																																																															_1: {ctor: '[]'}
																																																													...
																																																													_1: {
																																																														...
																																																														_0: A2(
																																																															_rtfeldman$elm_css$Css$class,
																																																															_meilab$elm_wexin_crypto$Styles_SharedStyles$Input,
																																																															{
																																																																ctor: '::',
																																																																_0: _rtfeldman$elm_css$Css$height(
																																																																	_rtfeldman$elm_css$Css$px(28)),
																																																														...
																																																														_1: {
																																																															...
																																																															_0: A2(
																																																																_rtfeldman$elm_css$Css$class,
																																																																_meilab$elm_wexin_crypto$Styles_SharedStyles$Result,
																																																																{
																																																																	ctor: '::',
																																																																	_0: _rtfeldman$elm_css$Css$displayFlex,
																																																																	_1: {
																																																															...
																																																															_1: {
																																																																...
																																																																_0: A2(
																																																																	_rtfeldman$elm_css$Css$class,
																																																																	_meilab$elm_wexin_crypto$Styles_SharedStyles$FinalPass,
																																																																	{
																																																																		ctor: '::',
																																																																		_0: A3(
																																																																			_rtfeldman$elm_css$Css$flex3,
																																																																...
																																																																_1: {
																																																																	...
																																																																	_0: A2(
																																																																		_rtfeldman$elm_css$Css$class,
																																																																		_meilab$elm_wexin_crypto$Styles_SharedStyles$PostPreview,
																																																																		{
																																																																			ctor: '::',
																																																																			_0: _rtfeldman$elm_css$Css$displayFlex,
																																																																			_1: {
																																																																										...
																																																																										_0: _rtfeldman$elm_css$Css_Elements$a(
																																																																											{
																																																																												ctor: '::',
																																																																												_0: _rtfeldman$elm_css$Css$color(
																																																																													_rtfeldman$elm_css$Css$hex('#404040')),
																																																																												_1: {
																																																																													ctor: '::',
																																																																													_0: _rtfeldman$elm_css$Css$textDecoration(_rtfeldman$elm_css$Css$none),
																																																																													_1: {
																																																																	...
																																																																	_1: {
																																																																		...
																																																																		_0: A2(
																																																																			_rtfeldman$elm_css$Css$class,
																																																																			_meilab$elm_wexin_crypto$Styles_SharedStyles$PostPreviewTitle,
																																																																			{
																																																																				ctor: '::',
																																																																				_0: _rtfeldman$elm_css$Css$fontSize(
																																																																		...
																																																																		_1: {
																																																																			...
																																																																			_0: A2(
																																																																				_rtfeldman$elm_css$Css$class,
																																																																				_meilab$elm_wexin_crypto$Styles_SharedStyles$PostPreviewSubtitle,
																																																																				{
																																																																					ctor: '::',
																																																																					_0: _rtfeldman$elm_css$Css$fontSize(
																																																																						_rtfeldman$elm_css$Css$px(15)),
																																																																			...
																																																																			_1: {
																																																																				...
																																																																				_0: A2(
																																																																					_rtfeldman$elm_css$Css$class,
																																																																					_meilab$elm_wexin_crypto$Styles_SharedStyles$PostPreviewMeta,
																																																																					{
																																																																						ctor: '::',
																																																																						_0: _rtfeldman$elm_css$Css$fontFamily(_rtfeldman$elm_css$Css$sansSerif),
																																																																						_1: {
																																																																							...
																																																																							_1: {
																																																																								...
																																																																								_1: {
																																																																									...
																																																																									_1: {
																																																																										ctor: '::',
																																																																										_0: _rtfeldman$elm_css$Css$marginTop(_rtfeldman$elm_css$Css$zero),
																																																																										_1: {ctor: '[]'}
																																																																									}
																																																																								}
																																																																							}
																																																																				...
																																																																				_1: {
																																																																					...
																																																																					_0: A2(
																																																																						_rtfeldman$elm_css$Css$class,
																																																																						_meilab$elm_wexin_crypto$Styles_SharedStyles$MorePostsLink,
																																																																						{
																																																																							ctor: '::',
																																																																							_0: A2(
																																																																								_rtfeldman$elm_css$Css$margin2,
																																																																					...
																																																																					_1: {
																																																																						...
																																																																						_0: A2(
																																																																							_rtfeldman$elm_css$Css$class,
																																																																							_meilab$elm_wexin_crypto$Styles_SharedStyles$PostContentPreview,
																																																																							{
																																																																								ctor: '::',
																																																																								_0: _rtfeldman$elm_css$Css$fontSize(
																																																																						...
																																																																						_1: {
																																																																							...
																																																																							_0: A2(
																																																																								_rtfeldman$elm_css$Css$class,
																																																																								_meilab$elm_wexin_crypto$Styles_SharedStyles$PostHead,
																																																																								{ctor: '[]'}),
																																																																							_1: {
																																																																								ctor: '::',
																																																																								_0: A2(
																																																																									...
																																																																									},
																																																																									{
																																																																										...
																																																																										_0: A2(
																																																																											...
																																																																											{
																																																																												ctor: '::',
																																																																												_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$HeaderNavWrapper),
																																																																												_1: {
																																																																													ctor: '::',
																																																																													_0: _rtfeldman$elm_css$Css$class(_meilab$elm_wexin_crypto$Styles_SharedStyles$IntroNavWrapper),
																																																																													_1: {ctor: '[]'}
																																																																												}
																																																																											},
																																																																											{
																																																																												...
																																																																												_1: {
																																																																													ctor: '::',
																																																																													_0: _rtfeldman$elm_css$Css$height(_meilab$elm_wexin_crypto$Styles_SharedVariables$navBarHeight),
																																																																													_1: {
																																																																														ctor: '::',
																																																																														_0: _rtfeldman$elm_css$Css$width(
																																																																															_rtfeldman$elm_css$Css$pct(100)),
																																																																										...
																																																																										_1: {
																																																																											...
																																																																											_0: A2(
																																																																												_rtfeldman$elm_css$Css$class,
																																																																												_meilab$elm_wexin_crypto$Styles_SharedStyles$IntroNavWrapper,
																																																																												{
																																																																													ctor: '::',
																																																																													_0: _rtfeldman$elm_css$Css$position(_rtfeldman$elm_css$Css$absolute),
																																																																													_1: {ctor: '[]'}
																																																																											...
																																																																											_1: {
																																																																													...
																																																																													},
																																																																													{
																																																																														...
																																																																														_1: {
																																																																															...
																																																																															_0: A3(
																																																																																...
																																																																																_rtfeldman$elm_css$Css$px(1),
																																																																																_rtfeldman$elm_css$Css$solid,
																																																																																_meilab$elm_wexin_crypto$Styles_Colors$bordercolor),
																																																																															_1: {
																																																																																ctor: '::',
																																																																																_0: _rtfeldman$elm_css$Css$backgroundImage(
																																																																																	A3(
																																																																																		...
																																																																																		_rtfeldman$elm_css$Css$stop(
																																																																																			_rtfeldman$elm_css$Css$hex('#827265')),
																																																																																		_rtfeldman$elm_css$Css$stop(
																																																																																			_rtfeldman$elm_css$Css$hex('#716053')),
																																																																																		{ctor: '[]'})),
																																																																																_1: {
																																																																																	ctor: '::',
																																																																																	_0: A4(
																																																																												...
																																																																												_1: {
																																																																													...
																																																																													_0: A2(
																																																																														_rtfeldman$elm_css$Css$class,
																																																																														_meilab$elm_wexin_crypto$Styles_SharedStyles$HeaderNavContainer,
																																																																														{
																																																																															ctor: '::',
																																																																															_0: _rtfeldman$elm_css$Css$displayFlex,
																																																																															_1: {
...
var _rtfeldman$elm_css$Css_File$UniqueSvgClass = function (a) {
	return {ctor: 'UniqueSvgClass', _0: a};
};
var _rtfeldman$elm_css$Css_File$uniqueSvgClass = _rtfeldman$elm_css$Css_File$UniqueSvgClass;

var _meilab$elm_wexin_crypto$Stylesheets$fileStructures = _rtfeldman$elm_css$Css_File$toFileStructure(
	{
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: '/static/css/app.css',
			_1: _rtfeldman$elm_css$Css_File$compile(
				{
					ctor: '::',
					_0: _meilab$elm_wexin_crypto$Styles_General$css,
					_1: {ctor: '[]'}
				})
		},
		_1: {ctor: '[]'}
	});
var _meilab$elm_wexin_crypto$Stylesheets$files = _elm_lang$core$Native_Platform.outgoingPort(
	'files',
	function (v) {
...
var _meilab$elm_wexin_crypto$Stylesheets$main = A2(_rtfeldman$elm_css$Css_File$compiler, _meilab$elm_wexin_crypto$Stylesheets$files, _meilab$elm_wexin_crypto$Stylesheets$fileStructures)();

var Elm = {};
Elm['Stylesheets'] = Elm['Stylesheets'] || {};
if (typeof _meilab$elm_wexin_crypto$Stylesheets$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Stylesheets$main(Elm['Stylesheets'], 'Stylesheets', undefined);
}
