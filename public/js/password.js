...
Elm['Password']['Password'] = Elm['Password']['Password'] || {};
if (typeof _meilab$elm_wexin_crypto$Password_Password$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Password_Password$main(Elm['Password']['Password'], 'Password.Password', undefined);
}
