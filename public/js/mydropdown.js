...
var Elm = {};
Elm['MyDropdown'] = Elm['MyDropdown'] || {};
if (typeof _meilab$elm_wexin_crypto$MyDropdown$main !== 'undefined') {
    _meilab$elm_wexin_crypto$MyDropdown$main(Elm['MyDropdown'], 'MyDropdown', undefined);
}
