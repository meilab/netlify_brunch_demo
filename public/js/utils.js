...
Elm['Password']['Utils'] = Elm['Password']['Utils'] || {};
if (typeof _meilab$elm_wexin_crypto$Password_Utils$main !== 'undefined') {
    _meilab$elm_wexin_crypto$Password_Utils$main(Elm['Password']['Utils'], 'Password.Utils', undefined);
}
